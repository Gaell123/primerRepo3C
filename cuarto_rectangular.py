# Este programa calcula el area de un cuarto rectangular y muestra el resultad en el sistema metrico (metros cuadrados)y en sistema imperial (pies cuadrados)
# 1. Inicio 
...
# 10. Imprimir "Ingresaste las siguientes dimensiones: ", metros."
